...
function haru_teespace_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'     => esc_html__( 'Drag and Drop Multiple File Upload for WooCommerce', 'teespace' ), // The plugin name
            'slug'     => 'drag-and-drop-multiple-file-upload-for-woocommerce', // The plugin slug (typically the folder name)
