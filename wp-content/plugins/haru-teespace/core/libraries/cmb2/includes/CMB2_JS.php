...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'haru-frames' ),
			'defaultString' => esc_html__( 'Default', 'haru-frames' ),
			'pick'          => esc_html__( 'Select Color', 'haru-frames' ),
			'current'       => esc_html__( 'Current Color', 'haru-frames' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'haru-frames' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'haru-frames' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'haru-frames' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'haru-frames' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'haru-frames' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'haru-frames' ) ),
					'nextText'        => esc_html__( 'Next', 'haru-frames' ),
					'prevText'        => esc_html__( 'Prev', 'haru-frames' ),
					'currentText'     => esc_html__( 'Today', 'haru-frames' ),
					'closeText'       => esc_html__( 'Done', 'haru-frames' ),
					'clearText'       => esc_html__( 'Clear', 'haru-frames' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'haru-frames' ),
					'timeText'      => esc_html__( 'Time', 'haru-frames' ),
					'hourText'      => esc_html__( 'Hour', 'haru-frames' ),
					'minuteText'    => esc_html__( 'Minute', 'haru-frames' ),
					'secondText'    => esc_html__( 'Second', 'haru-frames' ),
					'currentText'   => esc_html__( 'Now', 'haru-frames' ),
					'closeText'     => esc_html__( 'Done', 'haru-frames' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'haru-frames' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'haru-frames' ),
				'upload_files' => esc_html__( 'Use these files', 'haru-frames' ),
				'remove_image' => esc_html__( 'Remove Image', 'haru-frames' ),
				'remove_file'  => esc_html__( 'Remove', 'haru-frames' ),
				'file'         => esc_html__( 'File:', 'haru-frames' ),
				'download'     => esc_html__( 'Download', 'haru-frames' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'haru-frames' ),
			),
		);
