        ...
        protected function register_controls() {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'condition' => [
                        'pre_style' => [ 'style-1', 'style-2', 'style-3', 'style-4', 'style-5', 'style-6', 'style-7', 'style-8', 'style-9', 'style-10', 'style-11', 'style-12', 'style-13', 'style-14', 'style-15', 'style-16', 'style-17', 'style-18', 'style-19', 'style-20', 'style-21', 'style-22' ],
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'condition' => [
                        'pre_style' => [ 'style-1', 'style-4', 'style-5', 'style-9', 'style-10', 'style-11', 'style-13', 'style-14', 'style-15', 'style-21' ],
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'condition' => [
                        'pre_style' => [ 'style-1', 'style-3', 'style-5', 'style-6', 'style-7', 'style-8', 'style-9', 'style-10', 'style-12', 'style-17', 'style-18' ],
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'label_block' => true,
                    'condition' => [
                        'pre_style' => [ 'style-3', 'style-5', 'style-6', 'style-8', 'style-9', 'style-10', 'style-11', 'style-16', 'style-17', 'style-18', 'style-19' ],
                    ],
                ]
            );
