...
if ( ! class_exists( 'Haru_TeeSpace' ) ) {
	final class Haru_TeeSpace {
		...
		public function init_widgets() {
			...
			// Register widget
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Logo_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Logo_Footer_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Footer_Link_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Footer_Text_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Nav_Menu_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Nav_Menu_Popup_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Nav_Menu_Sidebar_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Nav_Menu_Template_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Heading_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Contact_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Social_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Video_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Counter_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Countdown_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Button_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Post_Featured_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Banner_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Banner_List_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Banner_Creative_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Tabs_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Images_Gallery_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Logo_Showcase_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Testimonial_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Team_Member_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Icon_Box_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Accordion_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Google_Maps_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Price_Table_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Particles_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Image_Blob_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Text_Animation_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Divider_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Decor_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Steps_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Icon_List_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Content_Slideshow_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Price_Calculator_Widget() );

			// Header
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Search_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Header_Contact_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Header_Button_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Close_Row_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Header_Icon_Box_Widget() );

			// Menu
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Menu_Post_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Menu_Tabs_Widget() );

			// Special TeeSpace
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Text_Scroll_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Text_List_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Text_Label_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Timeline_Widget() );

			// Slideshow
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Romeo_Slideshow_Widget() );
			\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Layla_Slideshow_Widget() );

			// Woo Widgets
			if ( class_exists( 'WooCommerce' ) ) {
				\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Woo_Search_Widget() );
				\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Woo_Cart_Widget() );
				\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Woo_Account_Widget() );
				if ( class_exists('YITH_WCWL') ) {
					\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Woo_Wishlist_Widget() );
				}
				\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Woo_Product_Best_Seller_Widget() );
				\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Woo_Product_Top_Sale_Widget() );
				\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Woo_Product_Top_Rated_Widget() );
				\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Woo_Ajax_Category_Widget() );
				\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Woo_Product_Slider_Widget() );
				\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Haru_TeeSpace\Widgets\Haru_TeeSpace_Woo_Ajax_Order_Widget() );
			}
		}
		...
		public function admin_assets() {
			...
			wp_enqueue_script( 'haru-teespace', plugins_url( HARU_TEESPACE_CORE_NAME . '/assets/js/admin.js' ), array( 'jquery' ), false, false );
